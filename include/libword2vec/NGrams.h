...
namespace Word2Vec
{
    void gramVocToWordVec(Vocabulary &voc, float *syn0, size_t max_string, size_t layer1_size, int ngram, int group_vec, int binary, int position, int overlap, char *train_file, char *output_file);
    void writeGrams(Vocabulary &voc, float *syn0, size_t layer1_size, int ngram, int position, char *output_file, int binary);
